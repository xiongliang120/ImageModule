package com.pingerx.imagego.core.strategy
...
class ImageOptions private constructor() {
    ...
    var isEngineRoundedCorners: Boolean = false//是否使用Glide的RoundedCorners实现圆角，不是自定义圆角转换器
     ...
     * 圆角边框大小
     */
    var roundBorderWidth: Int = 0
    /**
     * 圆角边框颜色
     */
    var roundBorderColor: Int = 0
    /**
     * 是否是黑白图像
     */
    ...
    class Builder {
        ...
        fun setEngineRoundedCorners(isEngineRoundedCorners: Boolean): Builder {
            config.isEngineRoundedCorners = isEngineRoundedCorners
            return this
        }
        ...
        fun setRoundBorderWidth(roundBorderWidth: Int): Builder {
            if (roundBorderWidth != 0) {
                config.roundBorderWidth = roundBorderWidth
            }
            return this
        }

        fun setRoundBorderColor(roundBorderColor: Int): Builder {
            if (roundBorderColor != 0) {
                config.roundBorderColor = roundBorderColor
            }
            return this
        }

        fun setIsBlackWhite(isBlackWhite: Boolean): Builder {
            config.isBlackWhite = isBlackWhite
            return this
        }
